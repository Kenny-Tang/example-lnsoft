...
public class QmtCodeGenerator {
	public static void main(String[] args) {
		FastAutoGenerator.create("jdbc:mysql://47.113.144.60:7500/qmt?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8", "root", "1234Qwer")
				.globalConfig(builder ->
					builder.author("tanjianwei") // 设置作者
							.outputDir(System.getProperty("user.dir") + "/qmt-service/src/main/java") // 设置输出路径
